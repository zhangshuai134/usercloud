...
import com.zs.user01.param.BaseParam;
import com.zs.user01.param.RedisParams;
import com.zs.user01.param.RedisRequest;
...
public class RedisUtil {
     ...
     * 优先级高的
     */
    public void rPush(String key, BaseParam req) {
        redisTemplate.opsForList().rightPush(key, req);
    }

    /**
     * 优先级高的
     */
    public void rPush(String key, RedisParams req) {
        redisTemplate.opsForList().rightPush(key, req);
    }
     ...
     * 优先级高的
     */
    public void rPushMany(String key, Collection value) {
        redisTemplate.opsForList().rightPushAll(key, value);
    }

    public void lPush(String key, BaseParam req) {
        redisTemplate.opsForList().leftPush(key, req);
    }

    public void lPush(String key, RedisRequest req) {
        redisTemplate.opsForList().leftPush(key, req);
    }
    ...
    public void lPushMany(String key, Collection value) {
